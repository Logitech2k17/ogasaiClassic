...
function vendorDB:setup()
	...
	-- Ally: Stranglethorn Vale // Альянс: Тернистая долина
	vendorDB:addVendor("Corporal Bluth", 0, 0, 33, false, true, true, true, true, -11295.8, -201.35, 75.6); -- drink, fruits, arrow, bullets // напитки, фрукты, стрелы, патроны
